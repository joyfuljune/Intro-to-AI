<body>
  <div class="wrapper">
    <nav id="sidebar" class="mCustomScrollbar _mCS_1 mCS-autoHide" style="overflow: visible;"><div id="mCSB_1" class="mCustomScrollBox mCS-minimal mCSB_vertical mCSB_outside" style="max-height: none;" tabindex="0"><div id="mCSB_1_container" class="mCSB_container" style="position: relative; top: -252px; left: 0px;" dir="ltr">
  ...
  <ul class="sidebar-list list-unstyled components">
    <li class="">
      <a href="01. 安装 Jupyter notebook.html">01. 安装 Jupyter notebook</a>
    </li>
    <li class="">
      <a href="02. notebook 界面.html" style="text-decoration: underline;">02. notebook 界面</a>
    </li>
    <li class="">
      <a href="03. Jupyter notebook 是什么？.html">03. Jupyter notebook 是什么？</a>
    </li>
    <li class="">
      <a href="04. 启动 notebook 服务器.html">04. 启动 notebook 服务器</a>
    </li>
    <li class="">
      <a href="05. Markdown 单元格.html">05. Markdown 单元格</a>
    </li>
    <li class="">
      <a href="06. Magic 关键字.html">06. Magic 关键字</a>
    </li>
    <li class="">
      <a href="07. 快捷键.html">07. 快捷键</a>
    </li>
    <li class="">
      <a href="08. 转换 notebook.html">08. 转换 notebook</a>
    </li>
    <li class="">
      <a href="09. 结语.html">09. 结语</a>
    </li>
    <li class="">
      <a href="10. 代码单元格.html">10. 代码单元格</a>
    </li>
    <li class="">
      <a href="11. 创建幻灯片.html">11. 创建幻灯片</a>
    </li>
  </ul>
...
</div></div><div id="mCSB_1_scrollbar_vertical" class="mCSB_scrollTools mCSB_1_scrollbar mCS-minimal mCSB_scrollTools_vertical" style="display: block;"><div class="mCSB_draggerContainer"><div id="mCSB_1_dragger_vertical" class="mCSB_dragger" style="position: absolute; min-height: 49.9915px; display: block; height: 338px; max-height: 494.439px; top: 161px;"><div class="mCSB_dragger_bar" style="line-height: 49px;"></div></div><div class="mCSB_draggerRail"></div></div></div></nav>
          ...
          <div class="row">
            <div class="col-12">
              <div class="align-items-middle">
                ...
                <h1 style="display: inline-block">02. notebook 界面</h1>
              </div>
            </div>
          </div>
        </div>
...
<div class="divider"></div>
          ...
          <div class="col-12">
            <p class="text-right">
              <a href="03. Jupyter notebook 是什么？.html" class="btn btn-outline-primary mt-4" role="button">Next Concept</a>
            </p>
          </div>
        </div>
      </main>
  ...
  <script>
    ...
    $(document).ready(function () {
      ...
      const currentInSideBar = $( "ul.sidebar-list.components li a:contains('02. notebook 界面')" )
